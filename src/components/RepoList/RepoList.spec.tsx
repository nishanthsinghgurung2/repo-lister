...
import { cleanup, findByTestId, findByText, fireEvent, render } from "@testing-library/react";
...
describe("RepoList", () => {
  ...
  afterEach(cleanup);
    ...
    it("show validation error if empty search title is submitted", async() => {
      ...
      const repoUrlElement = await findByTestId(container, "repo-search-validation-error");
      expect(repoUrlElement).toBeTruthy();
    });
